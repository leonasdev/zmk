...
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_RICK_001 uint8_t rick_001_map[] = ExpandRLEArray(1);
...
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_RICK_002 uint8_t rick_002_map[] = ExpandRLEArray(2);
